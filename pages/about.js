...
const About = () => {
  return (
    <>
      <NextSeo
        title="about | nagisa-profile"
        description="Hayami Nagisaの自己紹介ページになります。質問等ありましたらフォームからお問い合わせいただけると幸いです。"
        canonical="https://nagisa-profile.com/about"
        openGraph={{
          type: "article",
          url: "https://nagisa-profile.com/about",
          title: "about | nagisa-profile",
          description:
                  ...
                  <div>
                    <div className="text-center mb-2">
                      <div className="inline-block rounded-full border-8 border-yellow-400 bg-yellow-400">
                        <Image src="/Nagisa.png" width="155px" height="auto" className="inline-block rounded-full" />
                      </div>
                    </div>
